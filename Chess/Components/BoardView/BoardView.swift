...
struct BoardView: View {
    ...
    init(board: Binding<Board>,
         ...
         legalMoves: [Position] = [],
         selectionColor: Color = Color.theme.selectedSquareColor,
            ...
            ZStack {
                ...
                Group {
                    BoardSquares(model.board, type: .light)
                        .fill(bottomLeftSquareColor == .dark ? Color.theme.lightSquareColor : Color.theme.darkSquareColor)
                    BoardSquares(model.board, type: .dark)
                        .fill(bottomLeftSquareColor == .dark ? Color.theme.darkSquareColor : Color.theme.lightSquareColor)
                }
                ...
                if let selectedSquare = selectedSquare,
                   ...
                   square.state != .nonexistent, selectedSquare.piece != nil {
                    Group {
                        Rectangle()
                            .fill(Color.theme.selectedSquareColor)
                            .frame(size: model.squareSize)
                            .opacity(0.5)
                        Circle()
