...
struct EditBoardView: View {
    ...
    // TODO: FIX - View shouldn't be managing bindings, should directly go through specific gameManager or pieceManager methods
//    init(game: Binding<GameModel>, gameManager: CoreDataGameManager) {
